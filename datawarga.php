...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <a class="navbar-brand" href="#">Maping Warga</a>
            ...
            <?php
             if($_SESSION['role']=="admin"){
              if($_POST['remove']){
                ...
                $hapus=mysqli_query($connect, "DELETE from datawarga where id='$idremovee'");
                if($hapus){
...
function initMap() {};
  ...
  window.operateEvents = {
    'click .edit': function (e, value, row, index) {
      ...
      location.href = "http://localhost/maping_kerja/inputwarga.php?id="+replacer(jsson);
