...
error_reporting(error_reporting() & ~E_NOTICE);
    ...
    if($_POST['daftar_submit']){
        if($_POST['idx']=="kosong"){
            ...
            $ekriteriawargatext=mysqli_escape_string($connect, $_POST['kriteriawargatext']);
            $ekriteriapkhtext=mysqli_escape_string($connect, $_POST['kriteriapkhtext']);
            $ekriteriawarga=mysqli_escape_string($connect, $_POST['kriteriawarga']);        
            $ekriteriapkh=mysqli_escape_string($connect, $_POST['kriteriapkh']);
            $editlagi = mysqli_query($connect, "update datapkh set nama='$enama', hp='$ehp', ttl='$ettl', alamat='$ealamat',  lat='$elat', lng='$elng', kriteriawarga='$ekriteriawargatext', kriteriapkh='$ekriteriawpkhtext', kode_kriteriapkh='$ekriteriapkh', kode_kriteriawarga='$ekriteriawarga'");
            if($editlagi){
                $error="Input data berhasil.";
                $status=1;
            }else{
...
<div class="container" style="padding-top:25px; padding-bottom:25px;">
    <div class="row col-12 justify-content-center">
        <div class="col-11 col-lg-11 col-xs-12 col-md-11 col-sm-11 col-xl-11">
            ...
            ?>
            <p class="h3"><?php if($_GET['id']!=""){echo "Edit Data PKH";}else{echo "Input Data PKH";};?></p>
            <hr>
            <div class="card">
                <div class="card-header">
